...
#apresentação
{
	echo "Instagram JPG downloader - dev 0.2 (3 de julho de 2016)";
	echo "================";
	...
	read -p "Usuário-alvo: " nome; #eu podia testar se o nome de usuário existe, em primeiro lugar, né?
	echo "----";
}
...
#passo 1 - baixar todas os índices da conta (ciclo)
{
	...
	{ 
		...
		grep -o https://scontent.cdninstagram.com/[a-z0-9/\._-]*\.jpg indice$contador_pagina.html >> links.html; #extraindo links JPG e adicionando ao fim do arquivo de links - no futuro vai ter que pegar vídeo também!
...
{ 
	echo -n "2) Começando a baixar as imagens (JPGs) linkadas...";
...
#despedida
{
	...
	echo "* o script baixa 3 vezes a foto de perfil, por página! - horrível;";
	echo "* o script não consegue baixar os vídeos - não tá legal;";
	echo "* o script baixa 2 vezes as mesmas imagens (miniatura e original) - ruim para contas grandes.";
	echo "* o script podia detectar se o(a) usuário(a) tem a conta privada ou pública...";
	echo "----";
}
